  ...
  return (
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <img src="/hero.jpg" alt="Hero Image" className="w-full h-[60vh] md:h-[80vh] object-cover" />
        ...
        <div className="relative">
          ...
          <div className="bg-white rounded-2xl p-4 max-w-full mx-auto relative h-64">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center space-y-2">
              <h3 className="text-xl font-semibold text-blue-900">{advice?advice:"My Thoughts today"}</h3>
              <Skeleton className="h-4 bg-blue-100 rounded w-48 mx-auto" />
              <Skeleton className="h-4 bg-blue-100 rounded w-60 mx-auto" />
              <Skeleton className="h-4 bg-blue-100 rounded w-40 mx-auto" />
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-center gap-4">
          <Link href="/dashboard">
            <Button className="bg-blue-600 px-8 py-6 rounded-full flex items-center gap-2">
              Start Writing <ChevronRight className="h-5 w-5" />
            </Button>
          </Link>
          <Link href="#features">
            <Button variant="outline" className="bg-white px-8 py-6 rounded-full flex border-blue-600 text-blue-600 hover:bg-blue-100">
              Learn More
            </Button>
          </Link>
        </div>
      ...
      <div className="space-y-24 mt-24">
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-6">
            ...
            <h3 className="text-2xl font-bold text-blue-900">Rich Text Editor</h3>
            <p className="text-lg text-blue-700">Express yourself fully with our powerful editor featuring:</p>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-blue-700">Track your emotional journey with powerful analytics:</p>
            <ul className="space-y-3">
              <li className="flex items-center gap-2">
                <div className="h-2 w-2 rounded-full bg-blue-400" />
          ...
          {faqs.map((faq, index) => {
            return (
             <AccordionItem key={faq.q} value={`item-${index}`}>
                <AccordionTrigger className="text-blue-900 text-lg">{faq.q}</AccordionTrigger>
                <AccordionContent className="text-blue-700">{faq.a}</AccordionContent>
             </AccordionItem>
            )
          })}
      ...
      <div className="mt-24">
        <Card className="bg-gradient-to-r from-blue-100 to-amber-100">
          <CardContent className="p-12 text-center">
            ...
            <Link href="/dashboard">
             <Button className="animate-bounce text-white bg-blue-600" size="lg">
